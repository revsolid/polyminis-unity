...
/////// Diffuse:
                ...
                float _value2 = 1.0;
                float4 _TemperatureColor = tex2D(_TemperatureTexture, i.uv0);
                float3 _blend1 = saturate((_TemperatureColor.rgb+(sceneColor.rgb*pow(saturate((_value2 + ( ((sceneZ-partZ) - _vector31) * (0.5 - _value2) ) / (((_MainColor.rgb*(10.0/_Density))+0.0) - _vector31))),_Fade))));
